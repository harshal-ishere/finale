...
mongoose.connect("mongodb+srv://harshal011kamble:b4icunokmidown@cluster0.zna34pu.mongodb.net/todolistDB"); //this line is use to connect to the mongodb server to the port 27017 and make a new database todolist
